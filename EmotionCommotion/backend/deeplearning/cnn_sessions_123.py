...
# Load data
X_train = np.load('../../../../local/whitened_data/iemo_X_whitened_40.npy')[0:split_index]
X_test = np.load('../../../../local/whitened_data/iemo_X_whitened_40.npy')[split_index:]
Y_train = np.load('../../../../local/whitened_data/iemo_y.npy')[0:split_index]
Y_test = np.load('../../../../local/whitened_data/iemo_y.npy')[split_index:]
...
# Save model
model.save('yt_5_40_sessions123.h5')
...
def plot_confusion_matrix(cm, title='CNN Confusion matrix', cmap=plt.cm.Greens,fontsize=14):
    ...
    plt.savefig("NNCM_sessions123.png",transparent=True,figsize=(20,20),dpi=120)
